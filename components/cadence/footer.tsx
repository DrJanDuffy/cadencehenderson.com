...
export function Footer() {
  const footerLinks = [
    ...
    { title: 'American Homes 4 Rent in Cadence', href: '/rentals/american-homes' },
    { title: 'Element 12 Rentals in Cadence', href: '/rentals/element-12' },
    { title: 'Adler Rentals in Cadence Henderson', href: '/rentals/adler' },
    { title: 'Beazer Homes in Cadence Henderson', href: '/new-homes/beazer-homes' },
    { title: 'Century Communities in Cadence', href: '/new-homes/century-communities' },
    { title: 'D.R. Horton Homes in Cadence', href: '/new-homes/dr-horton' },
    { title: 'Taylor Morrison in Cadence Henderson', href: '/new-homes/taylor-morrison' },
    ...
    { title: 'Cadence Animal Hospital', href: '/lifestyle/animal-hospital' },
